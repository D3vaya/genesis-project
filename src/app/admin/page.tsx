          ...
          <CardContent className="space-y-4">
            <div className="grid gap-3">
              <Button
                ...
                onClick={() =>
                  toast.info('Gestión de Usuarios', {
                    description: 'Abriendo panel de usuarios',
                  })
                }
              >
              ...
              <Button
                ...
                className="h-auto justify-start p-4"
                onClick={() =>
                  toast.info('Base de Datos', {
                    description: 'Abriendo herramientas de BD',
                  })
                }
              >
              ...
              <Button
                ...
                onClick={() =>
                  toast.info('Logs', {
                    description: 'Abriendo logs del sistema',
                  })
                }
              >
